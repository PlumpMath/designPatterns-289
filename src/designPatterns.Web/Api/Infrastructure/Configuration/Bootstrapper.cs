...
using designPatterns.Web.Api.Infrastructure.RestExceptions;
using Nancy;
...
using TokenDoesNotExistException = designPatterns.Web.Api.Infrastructure.Authentication.TokenDoesNotExistException;
