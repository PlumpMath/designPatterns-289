'use strict';
var app = angular.module('designPatterns', ['ng', 'ngRoute', 'designPatterns.Controllers', 'designPatterns.Services', 'designPatterns.Directives']);


angular.module('designPatterns.Controllers', []);
angular.module('designPatterns.Services', []);
angular.module('designPatterns.Directives', []);
...
app.config(function($routeProvider) {
    ...
    .run(function ($rootScope, $location, loginService, userService, menuService) {
        var routesThatDontRequireAuth = ['/login', '/forgot-password','/reset-password','/register', 'home'];
